...
async function getStandList(id: string): Promise<ReservationDTO[] | ErrorDTO> {
  try {
...
async function getReservationList(id: string): Promise<ReservationDTO[] | ErrorDTO> {
  try {
...
export { getStandList, getReservationList, getReservationInfo, deleteReservation };
